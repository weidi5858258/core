...
public class View implements Drawable.Callback, KeyEvent.Callback,
    ...
    /**
     * @hide NOTE: This flag may only be used in subtreeSystemUiVisibility. It is masked
    ...
    /**
     * @hide Whether Recents is visible or not.
     */
    public static final int RECENT_APPS_VISIBLE = 0x00004000;

    /**
     * @hide Makes system ui transparent.
     */
     ...
     * @hide Indicates whether this view will participate in data collection through
     ...
     * @hide Controls whether assist data collection from this view and its children is enabled
     ...
     * if baseline alignment is not supported同基线对齐
     */
    @ViewDebug.ExportedProperty(category = "layout")
    ...
    public void setAnimation(Animation animation) {
        ...
        if (animation != null) {
            ...
            if (mAttachInfo != null &&
                    mAttachInfo.mDisplayState == Display.STATE_OFF &&
     ...
     * 判断这个alpha值被设置以后这个View能不能正常地表现出来，如果能，就返回ture
     */
     ...
     *                   {@link #SYSTEM_UI_FLAG_LAYOUT_HIDE_NAVIGATION},
     *                   {@link #SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN},
     *                   {@link #SYSTEM_UI_FLAG_IMMERSIVE},
     *                   and
     *                   {@link #SYSTEM_UI_FLAG_IMMERSIVE_STICKY}.
     */
